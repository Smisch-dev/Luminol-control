...
debug:
	go build -ldflags="-X github.com/Smisch-dev/Luminol-control/system.Version=$(GIT_HEAD)"
...
rmdebug:
	go build -gcflags "all=-N -l" -ldflags="-X github.com/Smisch-dev/Luminol-control/system.Version=$(GIT_HEAD)" -race
